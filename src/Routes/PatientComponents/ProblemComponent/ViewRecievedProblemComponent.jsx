...
export default class ViewRecievedProblemComponent extends Component {
    ...
    loadRecordDetail(){
        PatientService.getRecievedRecordById(this.state.problemid).then(res => {
            let p = res.data.patientData;
