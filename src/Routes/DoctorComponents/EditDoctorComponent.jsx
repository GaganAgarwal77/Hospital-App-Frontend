...
export default class EditDoctorComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
            Doctorid: '',
    ...
    loadDoctor() {
        DoctorService.getDoctorById(window.localStorage.getItem("DoctorId")).then((res) => {
            let p = res.data;
            this.setState({
                Doctorid: p.Doctorid,
                name: p.name,
    ...
    editDoctor = (e) => {
        ...
        Doctor['Doctorid'] = window.localStorage.getItem("DoctorId");
        DoctorService.editDoctor(Doctor).then(res => {
            this.props.history.push('/Doctors');
            alertify.success("Updated Doctor is ok");
        });
    }
            ...
            <div className="row">
                <div className="col-lg-7">
                    ...
                    <form>
                        ...
                        <button className="btn btn-success" onClick={this.editDoctor}>Update</button>
                    </form>
                </div>
                <div className="col">
